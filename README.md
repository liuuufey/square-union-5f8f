...
```
npm create cloudflare@latest -- --template=cloudflare/templates/square-union-5f8f
```

A live public deployment of this template is available at [https://square-union-5f8f.templates.workers.dev](https://square-union-5f8f.templates.workers.dev)
